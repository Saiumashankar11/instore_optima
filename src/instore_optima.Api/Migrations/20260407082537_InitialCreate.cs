    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplenishmentLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_ReplenishmentLogs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReplenishmentLogs_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "SupplierId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReplenishmentOrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplenishmentOrders", x => x.ReplenishmentOrderId);
                    table.ForeignKey(
                        name: "FK_ReplenishmentOrders_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReplenishmentOrders_Users_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplenishmentRules", x => x.RuleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_ReplenishmentOrders_ReplenishmentOrderId",
                        column: x => x.ReplenishmentOrderId,
                        principalTable: "ReplenishmentOrders",
                        principalColumn: "ReplenishmentOrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_ReplenishmentOrderId",
                table: "PurchaseOrders",
                column: "ReplenishmentOrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReplenishmentLogs_ProductId",
                table: "ReplenishmentLogs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ReplenishmentLogs_SupplierId",
                table: "ReplenishmentLogs",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ReplenishmentOrders_ApprovedBy",
                table: "ReplenishmentOrders",
                column: "ApprovedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ReplenishmentOrders_ProductId",
                table: "ReplenishmentOrders",
                column: "ProductId");
