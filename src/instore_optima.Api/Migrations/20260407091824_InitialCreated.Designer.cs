// <auto-generated />
// EF Core-generated migration snapshot for the InitialCreated (empty) migration.
...
namespace instore_optima.Api.Migrations
{
    ...
    [Migration("20260407091824_InitialCreated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Order_Items", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.ReplenishmentOrder", b =>
                {
                    b.Property<int>("ReplenishmentOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.ReplenishmentRule", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.Replenishment_Log", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.Order_Items", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Products", "Product")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Core.Entities.PurchaseOrder", b =>
                {
                    b.HasOne("Core.Entities.ReplenishmentOrder", "ReplenishmentOrder")
                        .WithOne("PurchaseOrder")
                        .HasForeignKey("Core.Entities.PurchaseOrder", "ReplenishmentOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ReplenishmentOrder");
            ...
            modelBuilder.Entity("Core.Entities.Receipt", b =>
                {
                    b.HasOne("Core.Entities.Payment", "Payment")
                        .WithOne("Receipt")
                        .HasForeignKey("Core.Entities.Receipt", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Stock", b =>
                {
                    b.HasOne("Core.Entities.Products", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("Core.Entities.Stock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Products", b =>
                {
                    ...
                    b.Navigation("ReplenishmentRules");
            ...
            modelBuilder.Entity("Core.Entities.PurchaseOrder", b =>
                {
                    b.Navigation("ReplenishmentLogs");
                });
